class CVRestrictionFinder {
  ...
  constructor() {
    ...
    this.tabName = this.pcfg.tabName
      ? this.pcfg.tabName
      : "CVRestrictionFinder";
    this.tabContentFile =
      "application/plugins/CVRestrictionFinder/tab-content.html";
    ...
    this.showRestrictionType = this.pcfg.showRestrictionType
      ? this.pcfg.showRestrictionType
      : [];
    ...
    this.showAlertModal = this.pcfg.showAlertModal
      ? this.pcfg.showAlertModal
      : false;
    ...
    this.routeRestrictionsStyles = {
      Fail: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          anchorYUnits: "pixels",
          scale: 0.23,
          src: "application/plugins/CVRestrictionFinder/img/violation.png",
        }),
      }),
      Temporary: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          anchorYUnits: "pixels",
          scale: 0.23,
          src: "application/plugins/CVRestrictionFinder/img/temporary.png",
        }),
      }),
      Override: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          anchorYUnits: "pixels",
          scale: 0.23,
          src: "application/plugins/CVRestrictionFinder/img/override.png",
        }),
      }),
      Pass: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          src: "application/plugins/CVRestrictionFinder/img/pass.png",
        }),
      }),
      Caution: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          anchorYUnits: "pixels",
          scale: 0.23,
          src: "application/plugins/CVRestrictionFinder/img/caution.png",
        }),
      }),
      ...
      Info: new ol.style.Style({
        image: new ol.style.Icon({
          ...
          anchorYUnits: "pixels",
          scale: 0.23,
          src: "application/plugins/CVRestrictionFinder/img/Info.png",
        }),
      }),
    };
    // Define route point styles
    ...
    this.allRestrictionLayer = new ol.layer.Vector({
      ...
      fields: [
        ...
        },
        {
          ...
          nameTransform: function (name) {
            if (
              app.plugins.CVRestrictionFinder.showRestrictionType.includes(
                "VERTICAL"
              ) ||
              app.plugins.CVRestrictionFinder.showRestrictionType.length === 0
            ) {
          ...
          valueTransform: function (value, feature) {
            if (
              ...
              var restrictionElement = $(
                '<div class="cvrf-r-container"></div>'
              );
              var rVertElement = $('<div class="cvrf-rVert-container"></div>');

              //Sort by lanes
              value.sort(
                (a, b) => a.RESTRICTION_LANE_NUMBER - b.RESTRICTION_LANE_NUMBER
              );
              ...
              $.each(value, function (i, restriction) {
                ...
                if (restriction.RESTRICTION_TYPE == "VERTICAL") {
                  ...
                  switch (restriction.RESTRICTION_STATUS) {
                    case "Fail":
                      laneValDiv =
                        '<div class=cvrf-vertsummary-lane-value style="background-color:rgb(242 0 0 / 35%);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                      break;
                    case "Override":
                      laneValDiv =
                        '<div class=cvrf-vertsummary-lane-value style="background-color:rgb(0 148 255 / 35%);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                      break;
                    default:
                      laneValDiv =
                        '<div class="cvrf-vertsummary-lane-value" style="background-color:rgb(255 255 255);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                  }
              ...
              $.each(value, function (i, restriction) {
                if (restriction.RESTRICTION_TYPE == "HORIZONTAL") {
                  ...
                  switch (restriction.RESTRICTION_STATUS) {
                    case "Fail":
                      status_ValDiv =
                        '<div class=cvrf-horsummary-value style="background-color:rgb(242 0 0 / 35%);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                      break;
                    default:
                      status_ValDiv =
                        '<div class="cvrf-horsummary-value" style="background-color:rgb(255 255 255);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                  }
                  var horSummary = $(
              ...
              $.each(value, function (i, restriction) {
                if (restriction.RESTRICTION_TYPE == "LENGTH") {
                  ...
                  switch (restriction.RESTRICTION_STATUS) {
                    case "Fail":
                      status_ValDiv =
                        '<div class=cvrf-lenSummary-value style="background-color:rgb(242 0 0 / 35%);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                      break;
                    default:
                      status_ValDiv =
                        '<div class="cvrf-lenSummary-value" style="background-color:rgb(255 255 255);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "m</p></div>";
                  }
                  var lenSummary = $(
        ...
        },
        {
          ...
          valueTransform: function (value, feature) {
            if (
              ...
              var rW_gvwElement = $(
                '<div class="cvrf-rweight-container"></div>'
              );
              $.each(value, function (i, restriction) {
                if (restriction.RESTRICTION_TYPE == "WEIGHT-GVW") {
                  ...
                  switch (restriction.RESTRICTION_STATUS) {
                    case "Fail":
                      status_ValDiv =
                        '<div class=cvrf-rweight_summary-value style="background-color:rgb(242 0 0 / 35%);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "kg</p></div>";
                      break;
                    default:
                      status_ValDiv =
                        '<div class="cvrf-rweight_summary-value" style="background-color:rgb(255 255 255);"><p >' +
                        restriction.RESTRICTION_VALUE +
                        "kg</p></div>";
                  }
                  var w_gvw_Summary = $(
              ...
              $.each(value, function (i, restriction) {
                if (restriction.RESTRICTION_TYPE == "NCV") {
                  ...
                  switch (restriction.RESTRICTION_STATUS) {
                    case "Fail":
                      status_ValDiv =
                        '<div class=cvrf-ncv_summary-value style="background-color:rgb(242 0 0 / 35%);"><p >' +
                        "Yes" +
                        "</p></div>";
                      break;
                    default:
                      status_ValDiv =
                        '<div class="cvrf-ncv_summary-value" style="background-color:rgb(255 255 255);"><p >' +
                        "No" +
                        "</p></div>";
                  }
                  var w_gvw_Summary = $(
          ...
          valueTransform: function (value, feature) {
            ...
            $.each(value, function (i, restriction) {
              if (restriction.RESTRICTION_TYPE == "INFO") {
                var status_ValDiv =
                  '<div class="cvrf-alert_summary-value" style="background-color:rgb(255 255 255);"><p >' +
                  restriction.PUBLIC_COMMENT +
                  "</p></div>";
                var w_gvw_Summary = $(
                  '\
        ...
        if (app.plugins.CVRestrictionFinder.waitingForMapClick === false) {
          ...
          app.map.forEachFeatureAtPixel(pixel, function (feature, layer) {
            if (isFirstFeature && feature.get("routePath")) {
              ...
              var clickCoordinate4326 = ol.proj.transform(
                clickCoordinateMap,
                app.map.getView().getProjection(),
                "EPSG:4326"
              );
    ...
    app.map.on("pointermove", function (e) {
      ...
      app.plugins.CVRestrictionFinder.routePathPointHoverLayer
        .getSource()
        .clear();
      ...
      app.map.forEachFeatureAtPixel(pixel, function (feature, layer) {
        ...
        if (feature.get("routePath")) {
          ...
          var routePathGeoJSON = gjFormat.writeFeaturesObject(
            app.plugins.CVRestrictionFinder.routePathLayer
              .getSource()
              .getFeatures(),
            {
          ...
          var routePathPointFeature4326 = transformFeature(
            routePathPointFeature,
            app.map.getView().getProjection(),
            "EPSG:4326"
          );
          var routePathPointGeoJSON = turf.point(
            routePathPointFeature4326.getGeometry().getCoordinates()
          );
          var routePathPointSnappedGeoJSON = turf.nearestPointOnLine(
            routePathGeoJSON,
            routePathPointGeoJSON,
            { units: "kilometers" }
          );
          // Transform that snapped location to the map projection and show it
          var routePathPointFeatures = gjFormat.readFeatures(
            routePathPointSnappedGeoJSON,
            {
              dataProjection: "EPSG:4326",
              featureProjection: app.map.getView().getProjection(),
            }
          ...
          app.plugins.CVRestrictionFinder.routePathPointHoverLayer
            .getSource()
            .addFeature(firstRoutePathPointFeature);
        }
      });
    });
  ...
  clearAll() {
    ...
    $("#cvrf-weight-input").val(
      app.plugins.CVRestrictionFinder.defaultWeightGVW
    );
    $("#cvrf-weight-TanA-input").val(
      app.plugins.CVRestrictionFinder.defaultWeight2AXLE
    );
    $("#cvrf-weight-TriA-input").val(
      app.plugins.CVRestrictionFinder.defaultWeight3AXLE
    );
    $("#cvrf-weight-SA-input").val(
      app.plugins.CVRestrictionFinder.defaultWeight1AXLE
    );
    ...
    app.plugins.CVRestrictionFinder.setRestrictionStatus(
  ...
  overrideRestrictions() {
    ...
    $.each(
      ...
      function (i, location) {
        if (location.STATUS != "Pass") {
          var RestrictionData = $(
            '<div class="cvrf-conflict-restriction-container"></div>'
          );
          ...
          var restrictionList = vRestrictions.concat(
            hRestrictions,
            lRestrictions,
            ncvRestrictions,
            wRestrictions
          ...
          $.each(restrictionList, function (i, restriction) {
            if (restriction.RESTRICTION_STATUS != "Pass") {
              ...
              switch (restriction.RESTRICTION_TYPE) {
                ...
                default:
                  restrictionType =
                    restriction.RESTRICTION_TYPE.charAt(0) +
                    restriction.RESTRICTION_TYPE.substring(1).toLowerCase();
              }
              ...
              var overrideSwitch = $(
                '<input class="form-check-input" type="checkbox" role="switch" id="overrideSwitch_' +
              ...
              if (
                app.plugins.CVRestrictionFinder.restrictionOverride.includes(
                  restriction.RESTRICTION_ID
                )
              ) {
              ...
              overrideSwitch.click(function () {
                if ($(this).is(":checked")) {
                  ...
                  $.each(
                    app.plugins.CVRestrictionFinder.routeRestrictionLayer
                      .getSource()
                      .getFeatures(),
                  ...
                  app.plugins.CVRestrictionFinder.restrictionOverride.push(
                    $(this).data("RestrictionID")
                  );
                  ...
                  let index =
                    app.plugins.CVRestrictionFinder.restrictionOverride.indexOf(
                      $(this).data("RestrictionID")
                    );
                  if (index != -1) {
                    app.plugins.CVRestrictionFinder.restrictionOverride.splice(
                      index,
                      1
                    );
                  }
          ...
          var zoomtobuttom = $(
            '<button title="Zoom to Location" id="cvrf-zoomto-btn" button type="button" class="btn btn-sm btn btn-light"><span class="oi oi-compass"></span></button>'
          );
    ...
    app.plugins.MultiFloatingWindow.open(
      "OverrideRestrictions",
  ...
  getPartitionedLayers(data, routeType) {
    ...
    if (!$("#cvrf-showOwnershipRoutes-btn").is(":checked")) {
      if (routeType == "Primary Route") {
        app.plugins.CVRestrictionFinder.primaryRoutePartitionLayer.setStyle(
          app.plugins.CVRestrictionFinder.hiddenRouteStyle
        );
      }
      if (routeType == "Permittable Route") {
        app.plugins.CVRestrictionFinder.permittableRoutePartitionLayer.setStyle(
          app.plugins.CVRestrictionFinder.hiddenRouteStyle
        );
      }
    }
    $.each(partitionDetails, function (partitionIndex, partition) {
      ...
      if (partition.endIndex == data.route.length - 1) {
        var partitionGeometry = new ol.geom.LineString(
          data.route.slice(startSlice)
        );
      } else {
        var partitionGeometry = new ol.geom.LineString(
          data.route.slice(startSlice, partition.endIndex + 1)
        );
      }
      var partitionGeometryInMapProjection = partitionGeometry.transform(
        "EPSG:" + data.srsCode,
        app.map.getView().getProjection()
      );
      ...
      if (routeType == "Primary Route") {
        app.plugins.CVRestrictionFinder.primaryRoutePartitionLayer
          .getSource()
          .addFeature(partitionFeature);
      }
      if (routeType == "Permittable Route") {
        app.plugins.CVRestrictionFinder.permittableRoutePartitionLayer
          .getSource()
          .addFeature(partitionFeature);
      }
    });
    ...
    if (routeType == "Primary Route") {
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.moti_Distance =
        moti_Distance;
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.fed_Distance =
        fed_Distance;
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.local_Road =
        local_Road;
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.ferry =
        ferry;
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.truckRouteDistance =
        truckRouteDistance;
      app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.nonTruckRouteDistance =
        nonTruckRouteDistance;
    }
    if (routeType == "Permittable Route") {
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.moti_Distance =
        moti_Distance;
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.fed_Distance =
        fed_Distance;
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.local_Road =
        local_Road;
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.ferry =
        ferry;
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.truckRouteDistance =
        truckRouteDistance;
      app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.nonTruckRouteDistance =
        nonTruckRouteDistance;
    }
    ...
    $.each(routeDirections, function (index, direction) {
      ...
      routeDirections[index].sortOrder =
        nearestRoutePoint.properties.featureIndex;
    });
  ...
  directions() {
    ...
    if (
      !$("#cvrf-showOwnershipRoutes-btn").is(":checked") &&
      !$("#cvrf-showTruckRoutes-btn").is(":checked")
    ) {
        ...
        if (direction.type != "STOPOVER") {
          ...
          if (direction.type != "Partition") {
            ...
            if (direction.truckRoute != truckRouteFlag[0]) {
              var splitText;
              if (direction.truckRoute == true)
                splitText =
                  "<div class='ownershipSplit' style='color:rgba(44, 95, 45)' ><b>Entering Truck Route</b></div>";
              if (direction.truckRoute == false)
                splitText =
                  "<div class='ownershipSplit' style='color:rgba(151, 188, 98)' ><b>Entering Non-Truck Route</b></div>";
              var partitionSplit = {
                distance: 0,
                name: direction.name,
        ...
        if (direction.type != "STOPOVER") {
          ...
          if (direction.type != "Partition") {
            ...
            if (
              ...
              direction.ferry === true
            ) {
              if (direction.name == null) {
                var splitText =
                  "<div class='ownershipSplit' style='color:rgba(50, 205, 50);'>Entering Local Government Permitted Road Network</div>";
              }
              if (direction.name == "Ministry of Transportation") {
                var splitText =
                  "<div class='ownershipSplit' style='color:rgba(43, 115, 218)' >Entering MOTT Permitted Road Network</div>";
              }
              if (direction.ferry === true) {
                var splitText =
                  "<div class='ownershipSplit' style='color:rgba(51, 171, 249)' >Entering Ferry Route</div>";
              }
              if (direction.name == "Federal Government") {
                var splitText =
                  "<div class='ownershipSplit' style='color:rgba(235, 45, 55);' >Entering Federal Permitted Road Network</div>";
              }
              ownershipPartionName = direction.name;
              var partitionSplit = {
                distance: 0,
    ...
    if (summaryStatistics.hasOwnProperty("travelDirections")) {
      ...
      var directionsTable = $(
        "<table class='table table-sm cvrf-directions-table'><tbody></tbody></table>"
      );
      ...
      $.each(directionDetails, function (index, leg) {
        ...
        switch (leg.type) {
          ...
          case "FINISH":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-start-end.png";
            break;
          case "CONTINUE":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-continue.png";
            break;
          case "TURN_LEFT":
          case "TURN_SHARP_LEFT":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-turn-left.png";
            break;
          case "TURN_RIGHT":
          case "TURN_SHARP_RIGHT":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-turn-right.png";
            break;
          case "TURN_SLIGHT_LEFT":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-turn-slight-left.png";
            break;
          case "TURN_SLIGHT_RIGHT":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-turn-slight-right.png";
            break;
          case "FERRY":
            navIcon = "application/plugins/CVRestrictionFinder/img/ferry.png";
            break;
          case "INFORMATION":
            navIcon = "application/plugins/CVRestrictionFinder/img/Info.png";
            break;
          case "Info":
            navIcon = "application/plugins/CVRestrictionFinder/img/Info.png";
            break;
          case "Failed":
            navIcon =
              "application/plugins/CVRestrictionFinder/img/violation.png";
            break;
          case "Caution":
            navIcon = "application/plugins/CVRestrictionFinder/img/caution.png";
            break;
          default:
            navIcon =
              "application/plugins/CVRestrictionFinder/img/navigation-unknown.png";
        }
        ...
        switch (leg.type) {
          case "Failed":
            direction = $(
              `<tr><td><img src="${navIcon}"style='height: 18px;width: 18px;'></td><td style="background-color: #ff000040;">${directionText}</td></tr>`
            ).data(leg);
            break;
          case "Caution":
            direction = $(
              `<tr><td><img src="${navIcon}"style='height: 18px;width: 18px;'></td><td style="background-color: #ffff0040;">${directionText}</td></tr>`
            ).data(leg);
            break;
          default:
            direction = $(
              `<tr><td><img src="${navIcon}"style='height: 18px;width: 20px;'></td><td>${directionText}</td></tr>`
            ).data(leg);
        }
        ...
        direction.hover(function () {
          ...
          var directionGeometryInMapProjection = directionGeometry.transform(
            "EPSG:4326",
            app.map.getView().getProjection()
          );
      ...
      if (summaryStatistics.nonTruckRouteDistance != 0) {
        var nonTruckRouteDistanceTotal = $(
          '<div class="cvrf-dSummary-container"><div class="cvrf-dSummary-container-name">Total Non-Truck Routes: </div><div class="cvrf-dSummary-container-value"><p style="color:rgb(151, 188, 98);">' +
            Math.round(
              this.primaryRouteSummaryStatistics.nonTruckRouteDistance
            ) +
            " km</p></div></div></div>"
        );
  ...
  findPermittableRoute() {
    if ($("#cvrf-toggle-permittable-route-switch").is(":checked")) {
      ...
      if (
        app.plugins.CVRestrictionFinder.routePointsLayer
          .getSource()
      ...
      var params = {
        ...
        snapDistance: 4000,
        restrictionValues: [
          "WEIGHT-1AXLE:" + loadWeight1AXLE + "",
          "WEIGHT-2AXLE:" + loadWeight2AXLE + "",
          "WEIGHT-3AXLE :" + loadWeight3AXLE + "",
          "NCV:1",
        ],
        simplifyDirections: true,
        excludeRestrictions:
          app.plugins.CVRestrictionFinder.restrictionOverride,
        roundTrip: false,
        correctSide: false,
      ...
      $.ajax({
        ...
        .done(function (data) {
          ...
          app.plugins.CVRestrictionFinder.permittableRouteLayer
            .getSource()
          ...
          // Update summary
          app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.travelDirections =
            data.directions;
          app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.routeDistance =
            data.distance.toFixed() + " " + data.distanceUnit;
          app.plugins.CVRestrictionFinder.updateSummary();

          //run partition route
          app.plugins.CVRestrictionFinder.getPartitionedLayers(
            data,
            "Permittable Route"
          );

          //Save Array to primaryRouteSummaryDirections has fallback directions when processing restrictions
          app.plugins.CVRestrictionFinder.primaryRouteSummaryDirections =
            app.plugins.CVRestrictionFinder.permittableRouteSummaryStatistics.travelDirections;
        ...
        .fail(function (jqxhr, settings, exception) {
          ...
          logger(
            "ERROR",
            app.plugins.CVRestrictionFinder.name + ": Router Error"
          );
        });
    }
  }
  ...
  generateRestrictionList(routeRestrctions) {
    ...
    $.each(routeRestrctions, function (index, location) {
      ...
      var restTitle =
        location.FEATURE_NAME + " - " + location.LOCATION_ROAD_NAME;
      if (location.FEATURE_NAME == null) {
        restTitle = location.LOCATION_ROAD_NAME;
      }
      var rest = $(
        `<div id="${location.LOCATION_ID}" class="card mb-3"></div>`
      ).appendTo(restrictionsList);
      var restHeader = $(
        `<h6 class="card-header rf-location-cards"></h6>`
      ).appendTo(rest);
      var titleContainer = $(
        `<div class="titlecontainer" style="display: flex;justify-content: space-between;"></div>`
      ).appendTo(restHeader);
      var titleInfo = $(`<div class="titleInfo"></div>`).appendTo(
        titleContainer
      );
      var titleContainerButtons = $(
        `<div class="titlecontainerbuttons"></div>`
      ...
      googleStreetButton.click(function () {
        app.plugins.CVRestrictionFinder.showLocationInGoogleStreetView(
          location.GEOMETRY
        );
      });
      $(
      ...
      var restrictionTabItem =
        $(`<li class="nav-item" id="navItem-restrictionBody${location.LOCATION_ID}" style="display: inline-flex;align-items: center;">
				<a class="nav-link" data-bs-toggle="tab" href="#restrictionBody${location.LOCATION_ID}">Restrictions</a>
			</li>`);
      var alertsTabItem =
        $(`<li class="nav-item" id="navItem-alerts${location.LOCATION_ID}" style="display: inline-flex;align-items: center;">
				<a class="nav-link" data-bs-toggle="tab" href="#alerts${location.LOCATION_ID}">Alerts</a>
			</li>`);
      var notesTabItem =
        $(`<li class="nav-item" id="navItem-notes${location.LOCATION_ID}" style="display: inline-flex;align-items: center;">
				<a class="nav-link" data-bs-toggle="tab" href="#notes${location.LOCATION_ID}">Notes</a>
			</li>`);
      var internalNotesTabItem =
        $(`<li class="nav-item" id="navItem-internalNotes${location.LOCATION_ID}" style="display: inline-flex;align-items: center;">
      ...
      var restrictionBody = $(
        `<div class="tab-pane container fade" id=${
          "restrictionBody" + location.LOCATION_ID
        }></div>`
      ).appendTo(detailsTabBody);
      var restrictionContainer = $(
        `<div id="restrictionContainer" class="card-deck mt-4"></div>`
      ).appendTo(restrictionBody);
      var rDimentionalCard = $(`<div id="rVertCard" class=""></div>`).appendTo(
        restrictionContainer
      );
      var notesBody = $(
        `<div class="tab-pane container fade" id=${
          "notes" + location.LOCATION_ID
        }></div>`
      ).appendTo(detailsTabBody);
      if (app.plugins.CVRestrictionFinder.pcfg.rdmApiEndPoint === "rdm-api") {
        var internalNotesBody = $(
          `<div class="tab-pane container fade" id=${
            "internalNotes" + location.LOCATION_ID
          }></div>`
        ).appendTo(detailsTabBody);
      }
      ...
      titleInfo.hover(function () {
        ...
        var restrictionGeometry = ol.proj.transform(
          coord,
          "EPSG:3005",
          "EPSG:4326"
        );
        var restrictionGeometry = new ol.geom.Point(restrictionGeometry);
        var restrictionGeometryInMapProjection = restrictionGeometry.transform(
          "EPSG:4326",
          app.map.getView().getProjection()
        );
      ...
      var dRestrictionContainer = $(
        '<div class="dRestriction-container class="card-deck mt-4" style="display: flex;align-items: center;"></div>'
      ).appendTo(rDimentionalCard);
      var heightWidthContainer = $(
        `<div id="heightWidthContainer" class=""></div>`
      ).appendTo(dRestrictionContainer);
      var lengthContainer = $(
        `<div id="lengthContainer" class=""></div>`
      ).appendTo(dRestrictionContainer);
      var laneContainer = $(
        `<div id="laneContainer" class="" style="display: flex;flex-direction: row;padding-bottom: 4px;justify-content: center;"></div>`
      ).appendTo(heightWidthContainer);
      var restrictionContainer = $(
        `<div id="restrictionContainer" class=""></div>`
      ).appendTo(heightWidthContainer);
      ...
      $(
        '<div id="widthrestrictiontitle" style="font-size: 11.5px;">WIDTH LIMIT</div>'
      ).appendTo(widthRestrictionContainer);
      ...
      var weightRestrictionContainer = $(
        `<div id="weight-restriction-container" class="" style="display: flex;padding: 0px;justify-content: center;flex-direction: column;align-items: center;"></div>`
      ).appendTo(restrictionContainer);
      location.DATA.sort(
        (a, b) => a.RESTRICTION_LANE_NUMBER - b.RESTRICTION_LANE_NUMBER
      );
      ...
      ///Weight Containers
      var weightSignContainer = $(
        `<div id="weight-restriction-sign-container" class="card" style="padding: 8px;width: fit-content;outline-offset: -4px;outline: 1px solid #000;border-radius: 6px;" ></div>`
      ).appendTo(weightRestrictionContainer);
      var weightSignTitle = $(
        `<div class="" id="title" style="display: flex;padding-top: 7px;justify-content: center;align-content: center;flex-direction: row;align-items: center;"></div>`
      ).appendTo(weightSignContainer);
      $(`<p> BRIDGE LOAD LIMIT</p>`).appendTo(weightSignTitle);

      var gvwContainer = $(
        `<div class="axle-container" id="gvwContainer" style="display: none;">`
      ).appendTo(weightSignContainer);
      var gvwValue = $(
        `<div class="" id="gvwValue" style="font-weight: bold;">0</div>`
      ).appendTo(gvwContainer);
      $(`<div class="" id="gvwName">G.V.W</div>`).appendTo(gvwContainer);

      var axle1Container = $(
        `<div class="axle-container" id="axle1Container" style="display: none;">`
      ).appendTo(weightSignContainer);
      $(`<div class="" id="axle1Name">SINGLE AXLE</div>`).appendTo(
        axle1Container
      );
      var axleValue = $(
        `<div class="" id="axleValue" style="font-weight: bold;">0</div>`
      ).appendTo(axle1Container);

      var axle2Container = $(
        `<div class="axle-container" id="axle2Container" style="display: none;">`
      ).appendTo(weightSignContainer);
      $(`<div class="" id="axle2Name">TANDEM AXLE</div>`).appendTo(
        axle2Container
      );
      var axle2Value = $(
        `<div class="" id="axle2Value" style="font-weight: bold;">0</div>`
      ).appendTo(axle2Container);

      var axle3Container = $(
        `<div class="axle-container" id="axle3Container" style="display: none;">`
      ).appendTo(weightSignContainer);
      $(`<div class="" id="axle3Name">TRIDEM AXLE</div>`).appendTo(
        axle3Container
      );
      var axle3Value = $(
        `<div class="" id="axle3Value" style="font-weight: bold;">0</div>`
      ).appendTo(axle3Container);

      $.each(location.DATA, function (index, restriction) {
        var restrictionTravelDirection = restriction.RESTRICTION_DIRECTION;
        if (
          restrictionTravelDirection == "B" ||
          restrictionTravelDirection == locationTravelDirection
        ) {
          if (restriction.RESTRICTION_TYPE == "VERTICAL") {
            vRestrictionCount += 1;
            var lane = $(
              `<div id="${restriction.RESTRICTION_LANE_NUMBER}" class="card" style="width: 80px;display: flex;flex-direction: column;align-items: center;"></div>`
            ).appendTo(laneContainer);
            var restrictionCard = $(
              `<div id="restrictionCard" class="card" style="width: -webkit-fill-available;border-radius: 3px;background: rgb(255 241 0);display: flex;flex-direction: column;"></div>`
            ).appendTo(lane);
            var laneDetailsCard = $(
              `<div id="laneDetailsCard" class="" style="height: 135px;display: flex;flex-direction: column;align-items: center;justify-content: space-evenly;align-content: stretch;"></div>`
            ).appendTo(lane);

            //Add linetype arrows for lane type class
            if (restriction.LANE_TYPE == "RA") {
              $(
                `<img src="application/plugins/CVRestrictionFinder/img/arrow-right-acceleration.png" alt="Trulli" width="14" height="16">`
              ).appendTo(laneDetailsCard);
            }
            if (restriction.LANE_TYPE == "RDRT") {
              $(
                `<img src="application/plugins/CVRestrictionFinder/img/arrow-right-deceleration.png" alt="Trulli" width="14" height="16">`
              ).appendTo(laneDetailsCard);
            }
            ...
            if (restriction.LANE_TYPE == "T" || restriction.LANE_TYPE == null) {
              $(`<div class="oi oi-arrow-top"></div>'`).appendTo(
                laneDetailsCard
              );
            }
            if (restriction.LANE_TYPE == "LT") {
              $(
                `<img src="application/plugins/CVRestrictionFinder/img/leftturn.png" alt="Trulli" width="14" height="16">`
              ).appendTo(laneDetailsCard);
            }
            //if restrction has status failed, add 1 to count and colour red
            var verticalRestrictionValue = $(
              `<div class="card-body" id="lane-value" style="display: flex;flex-direction: column;align-items: center;border-radius: 4px;outline: 1px solid #000;outline-offset: -3px;"></div>`
            );
            if (restriction.RESTRICTION_STATUS == "Fail") {
              ...
              $(
                `<div class="arrow oi oi-ban" style="color: red;"></div>`
              ).appendTo(laneDetailsCard);
              $(verticalRestrictionValue).css("color", "red");
            }
            if (restriction.RESTRICTION_STATUS == "Pass") {
              $(
                `<div class="arrow oi oi-check" style="color: green;"></div>'`
              ).appendTo(laneDetailsCard);
            }
            verticalRestrictionValue.appendTo(restrictionCard);
            $(
              `<div class="" id="width-value" style="font-weight: bold;">${
                restriction.RESTRICTION_VALUE + "m"
              }</div>`
            ).appendTo(verticalRestrictionValue);
            $(`<span class="oi oi-arrow-thick-bottom"></span>`).appendTo(
              verticalRestrictionValue
            );
            $(
              `<div class="" id="lane-number">${
                "Lane " + restriction.RESTRICTION_LANE_NUMBER
              }</div>`
            ).appendTo(laneDetailsCard);
          }
          if (restriction.RESTRICTION_TYPE == "HORIZONTAL") {
            ...
            if (restriction.RESTRICTION_STATUS == "Fail") {
              failedRestrictionCount += 1;
              var widthValue = $(
                `<div class="" id="width-value" style="padding-left: 10px;padding-right: 10px;font-weight: bold;">${
                  restriction.RESTRICTION_VALUE + "m"
                }</div>`
              ).appendTo(widthRestrictionContainer);
          ...
          if (restriction.RESTRICTION_TYPE == "LENGTH") {
            ...
            if (restriction.RESTRICTION_STATUS == "Fail") {
              failedRestrictionCount += 1;
              $(
                `<div class="" id="width-value" style="color: red;font-weight: bold;">${
                  restriction.RESTRICTION_VALUE + "m"
                }</div>`
              ).appendTo(lengthRestrictionContainer);
            }
            if (restriction.RESTRICTION_STATUS == "Pass") {
              $(
                `<div class="" id="width-value" style="font-weight: bold;">${
          ...
          if (restriction.RESTRICTION_TYPE == "INFO") {
            ...
            if (restriction.PUBLIC_COMMENT != null) {
              alertCount += 1;
              $(
                `<div class="" id="alerts" style="padding-bottom: 20px;padding-top: 20px;">${
                  "<li id=restriction-tab-alert>" +
                  urlify(restriction.PUBLIC_COMMENT) +
                  "</li>"
                }</div>`
              ).appendTo(alertsBody);
            }
          ...
          if (
            restriction.RESTRICTION_TYPE == "WEIGHT-GVW" ||
            restriction.RESTRICTION_TYPE == "WEIGHT-1AXLE" ||
            restriction.RESTRICTION_TYPE == "WEIGHT-2AXLE" ||
            restriction.RESTRICTION_TYPE == "WEIGHT-3AXLE"
          ) {
            wRestrictionCount += 1;
          ...
          if (restriction.RESTRICTION_TYPE == "NCV") {
            ...
            var message =
              "Route is restricted for commercial vehicles travelling  " +
              direction.toLowerCase() +
              "  at " +
              restTitle;
            $(
              `<span><img src=application/plugins/CVRestrictionFinder/img/no-commercial.PNG style="height: 60px;" ></span><span>` +
                message +
                `</span></div>`
            ).appendTo(dRestrictionContainer);
          }
          ...
          if (restriction.PUBLIC_COMMENT != null) {
            if (restriction.RESTRICTION_TYPE != "INFO") {
              ...
              var pubCommentContainer = $(
                '<div class="public-comment-container"></div>'
              ).appendTo(notesBody);
              ...
              if (restriction.RESTRICTION_TYPE == "VERTICAL") {
                ...
                ).appendTo(pubCommentContainer);
              } else {
                $(
                  `<div class="public-comment">${urlify(
                    restriction.PUBLIC_COMMENT
                  )}</div>`
                ).appendTo(pubCommentContainer);
              }
          ...
          if (restriction.INTERNAL_COMMENT != null) {
            if (restriction.RESTRICTION_TYPE != "INFO") {
              ...
              var internalCommentContainer = $(
                '<div class="internal-comment-container"></div>'
              ).appendTo(internalNotesBody);
              ...
              if (restriction.RESTRICTION_TYPE == "VERTICAL") {
                $(
                  `<div class="public-comment">${
                    ...
                    restriction.RESTRICTION_LANE_NUMBER +
                    " - " +
                    urlify(restriction.INTERNAL_COMMENT)
                  }</div>`
                ).appendTo(internalCommentContainer);
              } else {
                $(
                  `<div class="public-comment">${urlify(
                    restriction.INTERNAL_COMMENT
                  )}</div>`
                ).appendTo(internalCommentContainer);
              }
            }
      ...
      if (vRestrictionCount == 0) {
        for (var i = 0; i < location.LANE_COUNT; i++) {
          var laneNumber = i + 1;
          var lane = $(
            `<div id="${laneNumber}" class="card" style="width: 82px;height: 200px;display: flex;flex-direction: column;align-items: center;justify-content: space-evenly;align-content: space-around;"></div>`
          ).appendTo(laneContainer);
          ...
          $(
            `<div class="" id="lane-number">${"Lane " + laneNumber}</div>`
          ).appendTo(lane);
        }
      }
      ...
      if (publicCommentCount > 0) {
        $("#navItem-notes" + location.LOCATION_ID).append(
          $(
            `<sup><span class="badge bg-danger">` +
              publicCommentCount +
              `</span></sup>`
          )
        );
      ...
      if (internalCommentCount > 0) {
        $("#navItem-internalNotes" + location.LOCATION_ID).append(
          $(
            `<sup><span class="badge bg-danger">` +
      ...
      if (alertCount > 0) {
        $("#navItem-alerts" + location.LOCATION_ID).append(
          $(
            `<sup><span class="badge bg-danger">` + alertCount + `</span></sup>`
          )
        );
      }
      if (failedWeightRestrictionCount > 0) {
        $("#navItem-restrictionBody" + location.LOCATION_ID).append(
          $(
            `<sup><span class="badge bg-danger">` +
              failedWeightRestrictionCount +
              `</span></sup>`
          )
        );
      }
  ...
  updateSummary() {
    ...
    var totalRouteRestrictions =
      app.plugins.CVRestrictionFinder.failedRestrictionCount;
    ...
    $.each(
      ...
      function (index, data) {
        const objectExists = alertRestrictions.some(
    ...
    $("#cvrf-total-restrictions-temporary-summary-text").text(
      app.plugins.CVRestrictionFinder.tempRestrictionCount
    );

    var totalCautionRestrictions =
      app.plugins.CVRestrictionFinder.cautionRestrictionCount;
    $("#cvrf-total-restrictions-caution-summary-text").text(
      totalCautionRestrictions
    );

    if (summaryStatistics.moti_Distance != null) {
      var totalMOTTDistance =
        "" + Number(summaryStatistics.moti_Distance).toFixed(0) + " km";
      $("#cvrf-distance-summary-MOTT").text(totalMOTTDistance);
    }

    if (summaryStatistics.fed_Distance != null) {
      var totalFedDistance =
        "" + Number(summaryStatistics.fed_Distance).toFixed(0) + " km";
      $("#cvrf-distance-summary-Fed").text(totalFedDistance);
    }

    if (summaryStatistics.local_Road != null) {
      var totalLocalDistance =
        "" + Number(summaryStatistics.local_Road).toFixed(0) + " km";
      $("#cvrf-distance-summary-Local").text(totalLocalDistance);
    }

    if (summaryStatistics.ferry != null) {
      var totalFerryDistance = 
      "" + Number(summaryStatistics.ferry).toFixed(0) + " km";
  ...
  showLocationInGoogleStreetView(locationGeomentry) {
    ...
    var streetViewUrl =
      ...
      locationGeometry.flatCoordinates[1] +
      "," +
      locationGeometry.flatCoordinates[0];
  ...
  getRouteRestrictions() {
    ...
    $.each(
      ...
      function (index, location) {
        if (TLIDS.includes(location.NETWORK_SEGMENT_ID)) {
          var directionGeometry = ol.proj.transform(
          ...
          var routeAzmithDirection =
            app.plugins.CVRestrictionFinder.getrouteAzimuth(segmentData);
          ...
          $.each(location.DATA, function (index, restriction) {
            ...
            if (
              restrictionTravelDirection == "B" ||
              restrictionTravelDirection == networkSegmentDirection
            ) {
              if (restriction.RESTRICTION_TYPE == "INFO") {
                (infoRestrctionCount += 1),
                  (infoComment = restriction.PUBLIC_COMMENT),
                  app.plugins.CVRestrictionFinder.informationRestrictions.push(
                    location
                  );
              }
              if (restriction.RESTRICTION_TYPE == "NCV") {
          ...
          if (infoRestrctionCount > 0) {
            app.plugins.CVRestrictionFinder.addRouteRestrictionLayerFeatures(
              location,
              "INFO",
              locationStatus
            );
            var partitionDetails = buildPartitionDetails(
              featureName,
              directionGeometry,
              infoComment,
              "Info"
          ...
          if (restrctionCount > 0) {
            switch (location.STATUS) {
              case "Caution":
                ...
                var text =
                  "Caution, route is partially restricted at " +
                  location.FEATURE_NAME;
                var partitionDetails = buildPartitionDetails(
                  featureName,
                  directionGeometry,
    ...
    if (failedRestrictionsCount > 0) {
      app.plugins.CVRestrictionFinder.routePathLayer.setStyle(
        app.plugins.CVRestrictionFinder.restrictedRouteStyle
      );
    } else {
      app.plugins.CVRestrictionFinder.routePathLayer.setStyle(
        app.plugins.CVRestrictionFinder.primaryRouteStyle
      );
    }
    ...
    app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.travelDirections =
      directionData;
    ...
    $.each(routeRestrctions, function (index, direction) {
      ...
      var nearestRoutePoint = turf.nearest(directionPoint, routePointsFC); // turf operations must be done in 4326
      routeRestrctions[index].sortOrder =
        nearestRoutePoint.properties.featureIndex;
    });
    // Sort the directions based on sortOrder
    ...
    app.plugins.CVRestrictionFinder.generateRestrictionList(
      routeRestrctionsList
    );
  ...
  getTLIDData(TLIDS, callback) {
    var spinner = new Spinner(app.spinnerOptionsMedium).spin(
      $(app.plugins.CVRestrictionFinder.tabContent)[0]
    );
    var attempts = 1;
    function requestRoadData() {
      var url =
        returnEnvironmentUrl(
          app.plugins.CVRestrictionFinder.pcfg.rdmApiEndPoint
        ) + "/roads";
      $.ajax({
        type: "POST",
        url: url,
        ...
        .fail(function (jqxhr, settings, exception) {
          ...
          if (attempts == 3) {
            var userMessage =
              "There was an error getting road data from the ITN Web Service, Please restart applicaion and try again. If error continues, please contract a IMB Spatial Team Member.";
    ...
    $("#simple-router-form")
      ...
      .each(function (index) {
        ...
        if (
          ...
          if ($(this).parent().hasClass("cvrf-route-point"))
            $(this).parent().remove();
        }
      });
    ...
    $("#simple-router-form")
      ...
      .each(function (routePointIndex, inputElement) {
        if (
          ...
          if (firstRoutePointIndex == null)
            firstRoutePointIndex = routePointIndex;
  ...
  getrouteAzimuth(segmentData) {
    var line = turf.lineString(
      app.plugins.CVRestrictionFinder.primaryRoute[0].route
    );
    ...
    var TLID_end = olFeature4326.getGeometry().getCoordinates()[
      olFeature4326.getGeometry().getCoordinates().length - 1
    ];
    var TLID_startPoint = turf.point([TLID_start[0], TLID_start[1]]);
    var TLID_endPoint = turf.point([TLID_end[0], TLID_end[1]]);
    var TLID_startPoint_snapped = turf.nearestPointOnLine(
      line,
      TLID_startPoint,
      { units: "kilometers" }
    );
    ...
    var TLID_startDistance = Math.abs(
      TLID_startPoint_snapped.properties.location
    );
  ...
  search(request, callback, options) {
    ...
    if (app.plugins.CVRestrictionFinder.pcfg.geoCoderEnabled) {
      ...
      app.plugins.CVRestrictionFinder.searchBcGeoCoder(
        request,
        overallResultsAggregator,
        options
      );
    ...
    if (app.plugins.CVRestrictionFinder.pcfg.visibleLayerSearchEnabled) {
      providersToSearchCount++;
      app.plugins.CVRestrictionFinder.searchLayers(
        request,
        overallResultsAggregator,
        options
      );
      ...
      if (layer instanceof ol.layer.Vector) {
        ...
        $.each(features, function (index, feature) {
          if (
            ...
            app.plugins.CVRestrictionFinder.pcfg.visibleLayerSearchMaxResults
          ) {
  ...
  addLocationInputEventHandlers(parentId) {
    ...
    $("#" + parentId + " .cvrf-location-input").catcomplete({
      ...
      select: function (event, selection) {
        app.plugins.CVRestrictionFinder.registerSearchSelectionLocation(
          $(this),
          selection.item
        );
      },
  ...
  getPointStyle(feature) {
    return app.plugins.CVRestrictionFinder.pointStyles[
      feature.get("pointStyle")
    ];
  }
  ...
  getRoutePartitionStyle(feature) {
    ...
    if (feature.get("ownership") == "Ministry of Transportation")
      owner = "MOTT";
  ...
  addAllRestrictionLayerFeatures(location, type, locationStatus) {
    ...
    var restrictionFeature3857 = transformFeature(
      pointFeature,
      "EPSG:3005",
      app.map.getView().getProjection()
    );
    app.plugins.CVRestrictionFinder.allRestrictionLayer
      .getSource()
      .addFeature(restrictionFeature3857);
  }
  /**
  ...
  setRestrictionStatus(data) {
    ...
    $.each(data, function (index, location) {
      ...
      if ($("#cvrf-show-all-restrictions-btn").is(":checked")) {
        if (infoRestrctionCount > 0) {
          app.plugins.CVRestrictionFinder.addAllRestrictionLayerFeatures(
            location,
            "INFO",
            locationStatus
          );
  ...
  toggleAllRestrictionsLayer() {
    ...
    if ($("#cvrf-show-all-restrictions-btn").is(":checked")) {
      ...
      app.plugins.CVRestrictionFinder.setRestrictionStatus(
        app.plugins.CVRestrictionFinder.allRestrictions
      );
    }
  }
  ...
  addRoutePoint(coordinate) {
    ...
    clone
      .find(".cvrf-location-input")
      .attr("id", "cvrf-route-point-input-" + uniqueId);
    ...
    if (coordinate) {
      clone
        .find(".cvrf-location-input")
        .val(formatCoordinateAsString(coordinate, 4326));
    ...
    if (
      app.plugins.CVRestrictionFinder.routePathLayer.getSource().getFeatures()
        .length == 1 &&
      coordinate
    ) {
      // Define GeoJSON formatter
      ...
      var newRoutePointSnapped = turf.nearestPointOnLine(
        routePathGeoJSON,
        newRoutePoint,
        { units: "kilometers" }
      );
      ...
      $("#simple-router-form")
        ...
        .each(function (index) {
          if (
            ...
            var routePoint = turf.point([
              $(this).attr("longitude"),
              $(this).attr("latitude"),
            ]);
            var routePointSnapped = turf.nearestPointOnLine(
              routePathGeoJSON,
              routePoint,
              { units: "kilometers" }
            );
            var routePointOffset = routePointSnapped.properties.location;
            if (newRoutePointOffset > routePointOffset)
              elementToAddNewRoutePointAfter = $(this).parent();
          }
        });
    }
    ...
    app.plugins.CVRestrictionFinder.addLocationInputEventHandlers(
      "cvrf-route-point-" + uniqueId
    );
  ...
  alertInfoRestrction() {
    ...
    if (app.plugins.CVRestrictionFinder.informationRestrictions.length > 0) {
      ...
      var alertRestrictionContainer = $(
        "<div id=alertRestrictionContainer class=alertContainer><label id=alertContainerLabel>Restrictions</label></div>"
      );
      var alertContainer = $(
        "<div id=alertContainer class=alertContainer><label id=alertContainerLabel>Alerts</label></div>"
      );
      ...
      $.each(alertRestrictions, function (index, infoRestrction) {
        var restTitle =
          infoRestrction.FEATURE_NAME +
          " - " +
          infoRestrction.LOCATION_ROAD_NAME;
        ...
        $.each(infoRestrction.DATA, function (index, restriction) {
          ...
          if (restriction.RESTRICTION_TYPE == "NCV") {
            ...
            $(alertRestrictionContainer).append(
              ' <li id="alertItem" >Route is restricted for commercial vehicles travelling  ' +
                direction.toLowerCase() +
                "  at " +
                restTitle +
                "</li>"
  ...
  findRoute() {
    ...
    // Determine if reverse route button should be enabled
    if (
      app.plugins.CVRestrictionFinder.routePointsLayer.getSource().getFeatures()
        .length > 1
    ) {
      $("#cvrf-reverse-route-btn").prop("disabled", false);
    } else {
    ...
    $.ajax({
      ...
      .done(function (data) {
        ...
        app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.travelDirections =
          directionData;
        app.plugins.CVRestrictionFinder.primaryRouteSummaryStatistics.routeDistance =
          data.distance.toFixed() + " " + data.distanceUnit;
        ...
        var limit = 500;
        var segmentFilter =
          "NETWORK_SEGMENT_ID IN (" + routeTLIDS.join(",") + ")";
        var typeFilter =
          "RESTRICTION_TYPE IN (" +
          app.plugins.CVRestrictionFinder.showRestrictionType
            .map((type) => `'${type}'`)
            .join(",") +
          ")";
        ...
        function getActiveLocations(callback) {
          $.ajax({
            ...
            .fail(function (jqxhr, settings, exception) {
              var error =
                "Error getting active restrictions (" +
                jqxhr.responseText +
                ")";
              logger("ERROR", error);
            });
        ...
        var callback = function (data) {
          ...
          $.each(data, function (index, location) {
            var ncvCount = 0;
            var tempCount = 0;
            var index = locationList.findIndex(
            ...
            if (index === -1) {
              ...
              lData["FEATURE_SOURCE_SYSTEM_KEY"] =
                location.FEATURE_SOURCE_SYSTEM_KEY;
          ...
          if (routeRestrictionTLIDS.length > 0) {
            app.plugins.CVRestrictionFinder.getTLIDData(
              routeRestrictionTLIDS,
              callback
            );
          }
        };
  ...
  scroll2SelectedRestrictions(event) {
    ...
    var featureLayer;
    var idList = [];
    var feature = app.map.forEachFeatureAtPixel(
      pixel,
  ...
  addPlugin() {
    ...
    var callback = function (success, tabNav, tabContent) {
      ...
      if (!success) {
        logger(
          "ERROR",
          app.plugins.CVRestrictionFinder.name + ": Plugin failed to initialize"
        );
        return;
      }
      // Set class variables
      ...
      app.plugins.CVRestrictionFinder.singleClick = app.map.on(
        "click",
        function (event) {
      ...
      if (app.plugins.CVRestrictionFinder.showRestrictionType.length > 0) {
        $.each(
          app.plugins.CVRestrictionFinder.showRestrictionType,
          function (index, restrictionType) {
            if (
              restrictionType == "HORIZONTAL" ||
              restrictionType == "VERTICAL" ||
              restrictionType == "LENGTH"
      ...
      $("#cvrf-showOwnershipRoutes-btn").click(function () {
        if ($(this).is(":checked")) {
          ...
          if ($("#cvrf-toggle-permittable-route-switch").is(":checked")) {
            app.plugins.CVRestrictionFinder.permittableRoutePartitionLayer.setStyle(
              app.plugins.CVRestrictionFinder.getRoutePartitionStyle
            );
            app.plugins.CVRestrictionFinder.updateSummary();
          } else {
            app.plugins.CVRestrictionFinder.primaryRoutePartitionLayer.setStyle(
      ...
      $(
        "#cvrf-height-input, #cvrf-weight-input, #cvrf-weight-SA-input, #cvrf-weight-TanA-input, #cvrf-weight-TriA-input, #cvrf-length-input, #cvrf-width-input"
      ).change(function () {
        var spinner = new Spinner(app.spinnerOptionsMedium).spin(
          $(app.plugins.CVRestrictionFinder.tabContent)[0]
        );
      ...
      function getActiveRestrictions() {
        ...
        var filterCondition =
          app.plugins.CVRestrictionFinder.showRestrictionType
            .map((value) => "RESTRICTION_TYPE LIKE '%" + value + "%'")
            .join(" OR ");
        //This is where to put load all restrictions
        var url =
          returnEnvironmentUrl(
      ...
      logger(
        "INFO",
        app.plugins.CVRestrictionFinder.name + ": Plugin successfully loaded"
      );
    };
    // Add the tab
